...
We can analyze the detection frequency, the number of detections per week/month should follow a Poisson distribution. I can divide the data in different weeks.
```{r}
